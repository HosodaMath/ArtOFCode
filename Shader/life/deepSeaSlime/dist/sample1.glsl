...
// 回転
vec2 rotate(vec2 position, float radian){ float c = cos(-radian);
  float s = sin(-radian);
...
vec3 create(vec2 coord){
  ...
  for(float i = 1.0; i <= 10.0; i++){
    ...
    offset.x = 8.0 * cos(2.0 * fbm(vec3(i * 10.0, j * 10.0, 2.0)) * time);
    offset.y = 5.0 * sin(2.0 * fbm(vec3(i * 10.0, j * 10.0, 1.0)) * time);
