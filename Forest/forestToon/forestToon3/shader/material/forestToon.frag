...
vec4 createWarter(vec2 position){
  ...
  color = mix(
    vec3(0.102, 0.6667, 0.102), 
    vec3(0.4, 0.902, 0.4235), 
    clamp((f * f) * 4.0, 0.0, 1.0)
  );

  color = mix(
    color, 
    vec3(0.0235, 0.502, 0.0235), 
...
void main(){
  ...
  vec4 shadowColor;
  if(intensity > 0.95){
    shadowColor = vec4(0.7882, 1.0, 0.7804, 1.0);
    shadowColor += warterColor;
  } else if(intensity > 0.5){
    shadowColor = vec4(0.4745, 0.9216, 0.498, 1.0);
    shadowColor += warterColor;
  }  else if(intensity > 0.25){
    shadowColor = vec4(0.2667, 0.8392, 0.2471, 1.0);
    shadowColor += warterColor;
  } else {
    shadowColor = vec4(0.1529, 0.4196, 0.1647, 1.0);
    shadowColor += warterColor;
  }
