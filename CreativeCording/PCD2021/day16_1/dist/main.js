...
const setup = () => {
    ...
    for (let count = 0; count < 20; count++) {
        ...
        location2[count] = new Vector2(Mathematics.random(width / 4, width - width / 4), Mathematics.random(height / 4, height - height / 4));
        velocity2[count] = new Vector2(Mathematics.random(-1, 1), Mathematics.random(-1, 1));
        /// 背景色
