...
let width = 0;
let height = 0;
let brushes_rect_coordinate1;
let brushes_rect_velocity1;
let brushes_rect_size;
const init = () => {
...
const paints = (canvas_size) => {
    let brushes = new BrushesRectangle(gl, brushes_rect_coordinate1, brushes_rect_size, brushes_rect_velocity1);
