...
/// back paints
let brushes_line_coordinate1: Vector2;
let brushes_line_velocity1: Vector2;
let brushes_line_size1: Vector2;

let brushes_line_coordinate2: Vector2;
let brushes_line_velocity2: Vector2;
let brushes_line_size2: Vector2;

/// main paints
let brushes_circle_coordinate1: Vector2;
let brushes_circle_velocity1: Vector2;
let brushes_circle_size1: number;

let brushes_circle_coordinate2: Vector2;
let brushes_circle_velocity2: Vector2;
let brushes_circle_size2: number;
let time: number;
const init = () => {
...
const back_paints = (canvas_size: Vector2) => {

  let brushes1 = new BrushesLine(gl, 
    brushes_line_coordinate1, brushes_line_size1, 
    brushes_line_velocity1
  )

  brushes1.paint_step(canvas_size);
  brushes1.paints_draw("rgba(175, 238, 238, 0.1)");
  
  let brushes2 = new BrushesLine(gl, 
    brushes_line_coordinate2, brushes_line_size2, 
    brushes_line_velocity2
  )
...
const main_paints = (canvas_size: Vector2) => {
  let brushes1 = new BrushesCircle(gl, 
    brushes_circle_coordinate1, brushes_circle_size1, 
  ...
  let brushes2 = new BrushesCircle(gl, 
    brushes_circle_coordinate2, brushes_circle_size2, 
    brushes_circle_velocity2
  )
