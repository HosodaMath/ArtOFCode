...
let width = 0;
let height = 0;
let brushes_rect_coordinate1: Vector2;
let brushes_rect_velocity1: Vector2;
let brushes_rect_size: Vector2;
const init = () => {
  canvas.width = width = window.innerWidth;
  canvas.height = height = window.innerHeight;

  brushes_rect_coordinate1 = new Vector2(Mathematics.random(0, width), Mathematics.random(0, height));
  brushes_rect_velocity1 = new Vector2(Mathematics.random(-2, 2), Mathematics.random(-1, 1));
  brushes_rect_size = new Vector2(Mathematics.random(10, 50), Mathematics.random(10, 50));
...
const paints = (canvas_size: Vector2) => {
  ...
  let brushes = new BrushesRectangle(gl, 
    brushes_rect_coordinate1, brushes_rect_size, 
    brushes_rect_velocity1
  )
